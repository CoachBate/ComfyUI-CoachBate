...
test("isBrowsableWorkflowFile accepts only .json and .png, case-insensitively", () => {
    assert.equal(isBrowsableWorkflowFile("MCB/foo.json"), true);
    assert.equal(isBrowsableWorkflowFile("MCB/foo.PNG"), true);
    assert.equal(isBrowsableWorkflowFile("MCB/foo.Json"), true);
    assert.equal(isBrowsableWorkflowFile("desktop.ini"), false);
    assert.equal(isBrowsableWorkflowFile("MCB/foo.json.bak"), false);
    assert.equal(isBrowsableWorkflowFile("Thumbs.db"), false);
    assert.equal(isBrowsableWorkflowFile("MCB/foo.mp4"), false);
    assert.equal(isBrowsableWorkflowFile("noext"), false);
});
